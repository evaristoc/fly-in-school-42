...
# from .GraphBehaviour import GraphBehaviour
...
class Graph():
    def __init__(self, graphdata: GraphData) -> None:
        ...
        # self._execute_costmethods: GraphBehaviour
        # self.methods.hub_connections = types.MethodType(
        #     methods.hub_connections, self
        # )
        # self.methods.compute_reverse_map = types.MethodType(
        #     methods.compute_reverse_map, self
        # )
        #  self._execute_costmethods()
    ...
    # def _execute_costmethods(self, costmethods: GraphBehaviour) -> None:
    #     self.reversecost_map: Optional[Dict[Zone, float]] = costmethods.reversecost_map
    #     self.hub_connections = costmethods.hub_connections
    #     self.compute_reverse_map = costmethods.compute_reverse_map
    #     self.hub_connections()
    #     self.compute_reverse_map()
